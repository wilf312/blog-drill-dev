...
まず、求められている仕事の一番簡単なものを最速最短で終わらせましょう。終わらせることが大事で一連の動作がどういう流れで終わり、誰に報告するのか、報告した後実際にお客さんに届くまでのイメージができると動き方のイメージをグッと自分の**知っている**の中に引き込むことができます。


その中で関わった人と雑談をしたり、自分がどういう人間で相手がどういう人間かを教えてもらいましょう。
